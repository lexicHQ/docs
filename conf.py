...
htmlhelp_basename = 'RecimeDocumentationdoc'
...
man_pages = [
    (master_doc, 'recimedocumentation', u'Recime Documentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RecimeDocumentation', u'Recime Documentation Documentation',
     author, 'RecimeDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
