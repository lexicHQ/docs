...
[`https://www.flickr.com/services/apps/create/`](https://www.flickr.com/services/apps/create/)` (use the “I'd rather use my own email address” version if you don’t want to set up a yahoo account)`
